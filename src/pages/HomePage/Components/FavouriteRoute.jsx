...
const FavouriteRoute = ({item, onFavouriteRouteClick}) => {
    const navigate = useNavigate();

    //Search Favourite Route
    const searchFavouriteRoute = (item) => {
        ...
        <div
            ...
            <div className="md:w-56 w-full px-2 py-4">
                <button
                    ...
                    onClick={() => onFavouriteRouteClick(item)}
                >
